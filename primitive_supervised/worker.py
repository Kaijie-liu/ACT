...
def execute(phase, root):
    from primitive_supervised.flow import limits, verify_sources
    root = Path(root)
    ...
    if phase == 'load':
        ...
        from primitive_supervised.construction import propose
        v = read(root / 'prepared.json')
...
if __name__ == '__main__':
    ...
    try:
        ...
        from primitive_supervised.flow import limits
