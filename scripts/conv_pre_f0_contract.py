...
PROTOCOL=ROOT/'scripts/conv_pre_f0_protocol.json'
DEFAULT=ROOT/'data/moe/results/conv_pre_f0_rational_20260915_r1'
FREEZE=ROOT/'act/pipeline/moe/results/conv_pre_f0_freeze_20260915_r1.json'
PARENT=ROOT/'act/pipeline/moe/results/conv_request_sign_lp_review_20260915_r1.json'
FILES=('scripts/conv_pre_f0_protocol.json','scripts/conv_pre_f0_contract.py',
       'scripts/run_conv_pre_f0.py','scripts/check_conv_pre_f0.py',
       'scripts/test_conv_pre_f0.py','docs/conv_pre_f0_r1.md')
