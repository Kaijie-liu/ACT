...
from scripts.conv_pre_f0_r2_contract import ROOT,read,save,sha,validate_job
...
def aggregate(m,snapshot,job,load):
    ...
    if (m['schema']!='CONV_PRE_F0_RATIONAL_R2_MANIFEST' or m['request']!=expected_scope(job)
