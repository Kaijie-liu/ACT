"""Full-request300s two-arm execution, same materialized box and global rows."""
import argparse
...
def worker(cfg, path, request_id, arm):
    ...
    if arm == 'act':
        ...
        out = verify_class_separated_box(ClassSeparatedTop1.from_metamoe(model), center=x, lower=lo, upper=hi,
