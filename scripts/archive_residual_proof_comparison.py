...
FREEZE=ROOT/'docs/residual_proof_freeze_review_20260925_r1.json'
AUDIT=ROOT/'docs/residual_proof_execution_audit_20260925_r1.json'
ARCHIVE=ROOT/'docs/residual_proof_execution_archive_20260925_r1.json'
...
def collect():
    ...
    for row in fresh['rows']:
        ...
        excluded_pairs=0 if route is None or 'route_check' not in completed_phases else route['frontier']['excluded_pairs']
    ...
    result={'schema':'RESIDUAL_PROOF_EXECUTION_ARCHIVE_R1','audit':fresh['audit'],'issues':fresh['issues'],
