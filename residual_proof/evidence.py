...
def aggregate(scope, doc, bundle, candidates, *, invocation, proposal_complete, deadline):
    ...
    construction = check(doc, bundle, invocation=invocation, expected_source_sha256=doc_hash, deadline=deadline)
    ...
    return {'schema': 'RESIDUAL_PROOF_REQUEST_V1', 'status': POSITIVE if closed else 'NOT_CLOSED',
