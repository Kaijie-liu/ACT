...
from residual_proof.run import GATE, CONFIG, DEST, sources

MODULES=['residual_proof.tests','shared_route_residual.tests','shared_route_residual.supervision_tests',
...
def main():
    ...
    row={'status':'PASS' if passed==EXPECTED_TESTS else 'FAIL','tests_passed':passed,'new_controls':23,
        'unchanged_regressions':98,'command':cmd,'output':output,'returncode':result.returncode,
