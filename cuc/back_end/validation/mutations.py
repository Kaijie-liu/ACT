...
class TFMutator:
    ...
    def M1_tighten_bounds(bounds: "Bounds", factor: float = 0.1) -> "Bounds":
        ...
        Expected: BBL should detect violations.
        """
        from cuc.back_end.core import Bounds as BoundsClass
    ...
    def M2_loosen_bounds(bounds: "Bounds", factor: float = 0.1) -> "Bounds":
        ...
        Expected: Neither CBR nor BBL should report errors.
        """
        from cuc.back_end.core import Bounds as BoundsClass
    ...
    def M3_swap_lb_ub(bounds: "Bounds") -> "Bounds":
        ...
        Expected: BBL should immediately detect this.
        """
        from cuc.back_end.core import Bounds as BoundsClass
    ...
    def M4_zero_lower_bound(bounds: "Bounds") -> "Bounds":
        ...
        Expected: BBL detects when negative activations exist.
        """
        from cuc.back_end.core import Bounds as BoundsClass
    ...
    def M5_scale_upper_bound(bounds: "Bounds", factor: float = 0.5) -> "Bounds":
        ...
        Expected: BBL detects when activations exceed scaled upper bound.
        """
        from cuc.back_end.core import Bounds as BoundsClass
    ...
    def M6_add_noise(bounds: "Bounds", std: float = 0.1, seed: Optional[int] = None) -> "Bounds":
        ...
        Expected: BBL may detect depending on noise direction.
        """
        from cuc.back_end.core import Bounds as BoundsClass
