# Test suite for Net JSON serialization and deserialization.
...
from cuc.back_end.serialization import (
...
def create_test_networks():
    """Load all networks from the examples folder using proper deserialization."""
    ...
    # Use proper serialization for loading
...
def run_all_tests():
    ...
    print("🚀 Running Serialization Test Suite")
    print("=" * 50)
