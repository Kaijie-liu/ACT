...
def solve_BaB_node(net, node: BabNode, solver: Solver, assert_layer) -> str:
    ...
    Uses lightweight Net evaluation to filter spurious counterexamples.
    """
    ...
    if status == SolveStatus.SAT and ce_input is not None:
        # Lightweight validation using Net point evaluation
...
def check_violation_at_point(net, x_np: np.ndarray, assert_layer) -> bool:
    """
    Lightweight validation: evaluate Net at a point and check property violation.
