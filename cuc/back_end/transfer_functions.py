...
# function implementations in the verification framework. Transfer
...
from cuc.back_end.core import Bounds, Fact, Layer, Net
...
def set_transfer_function_mode(mode: str = "interval") -> None:
    ...
    """
    if mode == "interval":
        from cuc.back_end.interval_tf import IntervalTF
        set_transfer_function(IntervalTF())
    elif mode == "hybridz":
        from cuc.back_end.hybridz_tf import HybridzTF
        set_transfer_function(HybridzTF())
    elif mode == "dual":
        from cuc.back_end.dual_tf import DualTF
