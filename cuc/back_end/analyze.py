# Network analysis functions for verification framework.
# Provides analysis capabilities for neural network structures and properties.

import torch
from collections import deque
from typing import Dict, Tuple
from cuc.back_end.core import Bounds, Fact, Net, ConSet
from cuc.back_end.utils import box_join, changed_or_maskdiff, update_cache
from cuc.back_end.transfer_functions import dispatch_tf, set_transfer_function_mode
...
def analyze(net: Net, entry_id: int, entry_fact: Fact, eps: float=1e-9) -> Tuple[Dict[int, Fact], Dict[int, Fact], ConSet]:
    ...
    Args:
        net: network structure containing layers and topology (preds/succs)
    ...
    try:
        from cuc.back_end.transfer_functions import get_transfer_function
