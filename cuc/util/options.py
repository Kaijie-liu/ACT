# Global performance and debugging options for the framework.

import os
from cuc.util.path_config import get_pipeline_log_dir
...
class PerformanceOptions:
    ...
    Attributes:
        ...
        debug_output_file: Path to debug log file (default: "cuc/pipeline/log/cuc_debug_tf.log")
    ...
    debug_output_file: str = os.path.join(get_pipeline_log_dir(), "cuc_debug_tf.log")
