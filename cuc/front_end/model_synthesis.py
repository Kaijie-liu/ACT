...
# for compatible model synthesis pipeline.
...
if __name__ == "__main__" and __package__ is None:
    ...
    print("  python -m cuc.front_end.model_synthesis")
    print("="*80 + "\n")
    sys.exit(1)
...
from cuc.front_end.spec_creator_base import LabeledInputTensor
from cuc.front_end.verifiable_model import (
    InputLayer,
    InputSpecLayer,
    OutputSpecLayer,
    VerifiableModel,
    ...
    if not spec_results:
        if creator == 'vnnlib':
            raise RuntimeError(
                ...
                "Examples:\n"
                "  python -m cuc.front_end --download acasxu_2023      # ACAS Xu collision avoidance\n"
                "  python -m cuc.front_end --download vit_2023          # Vision Transformer\n"
            ...
            raise RuntimeError(
                ...
                "Examples:\n"
                "  python -m cuc.front_end --download MNIST              # Downloads MNIST + all models\n"
                "  python -m cuc.front_end --download CIFAR10            # Downloads CIFAR10 + all models\n"
                "  python -m cuc.front_end --list                        # Show all available datasets\n"
                "  python -m cuc.front_end --list-downloads              # Show what's already downloaded\n"
            )
...
if __name__ == "__main__":
    ...
    from cuc.util.device_manager import initialize_device
