...
run_one() {
  ...
  # NOTE: -nojvm REMOVED — NNV's exact-star uses parpool which needs JVM.
  # The cost is ~5-10s extra MATLAB startup per instance, acceptable vs.
  # silently dropping every exact-star benchmark (malbeware, dist_shift, etc.).
  NNV_STRICT_NO_HELPER=1 \
