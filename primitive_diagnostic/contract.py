...
from primitive_supervised.flow import sources as component_sources
from primitive_basis.engine import POLICY as ARITHMETIC
...
FREEZE=ROOT/'docs/primitive_diagnostic_v1_freeze.json'
REVIEW=ROOT/'docs/primitive_diagnostic_v1_selection_review.json'
CONTROL_REVIEW=ROOT/'docs/primitive_diagnostic_v1_controls_review.json'
OUTPUT=ROOT/'data/moe/results/primitive_diagnostic_real_20260920_v1'
PRIOR=ROOT/'docs/fidelity_supervised_real_v2_execution_results.json'
INTEGRATION=ROOT/'docs/primitive_supervised_controls_attempt001.json'
INTEGRATION_REVIEW=ROOT/'docs/primitive_supervised_v1_review.json'
POLICY={
    ...
    'comparison':'saved V2 descriptive context; record hint/system equality, not matched timing',
...
def verify_sealed():
    from primitive_supervised.controls import old
    old()
...
def freeze(controls):
    ...
    value={'schema':'PRIMITIVE_DIAGNOSTIC_FREEZE_V1','status':'FROZEN_NOT_EXECUTED',
...
def validate(value):
    if (value['schema']!='PRIMITIVE_DIAGNOSTIC_FREEZE_V1' or value['status']!='FROZEN_NOT_EXECUTED'
