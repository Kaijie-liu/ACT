...
|---|---:|---:|---|
| `act/pipeline/hybridz_sparse_exact_probe.py` | 5092 | 0 | biggest remaining package-level prototype; first post-freeze consolidation target is partially reduced |
